...
static void newviewFlexCat(int tipCase, double *extEV,
			   ...
			   int n, double *left, double *right, int *wgt, int *scalerIncrement, const fakeboolean useFastScaling, const int numStates)
{
  double
    *le, *ri, *v, *vl, *vr,
    ump_x1, ump_x2, x1px2;
...
static void makeP(double z1, double z2, double *rptr, double *EI,  double *EIGN, int numberOfCategories, double *left, double *right, int data, fakeboolean saveMem, int maxCat)
{
  int i, j, k;
