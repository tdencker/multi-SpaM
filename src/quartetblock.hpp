...
* assumed that there is only one Word per sequence. This class was previously
* used for more tasks and has, therefore, a bunch of convinience functions. The
* words are copied from the original vector and can be deleted after pushing
* them into the quartet block.
**/
