...
/*---Constructor-------------------------------------------------------------*/
/**
 * Default constructor, sets the default vaulues, pattern will be generated
 * automatically.
 */
variance::variance()
{
...
/**
 * Long constructor, sets the values; resets automatically, if there are
 * problems.
 *
 * @param size 			Number of patterns for the patternset.
 *
...
/**
 * File constructor, sets values only from files; resets automatically if there
 * are problems.
 *
 ...
 *
 * @param p1 			Position of the first used pattern of the
 *pattern
 *set.
 *
 * @param p2			Position of the second used pattern of the
 *pattern
 *set.
 *							NOTE: possible is p1 =
 *p2
 *
 * @param s				The shift of the second pattern, s < 0
 *:=
 *shift left
 *							pattern 2, s > := shift
 *right
 ...
 *
 * @param limits		The number of patterns which have to be selected
 * and
 * mayby modified.
 */
...
/**
 * Improvement with reinitialization. Improves a patternset, resets it 'loops'
 * times and
 ...
 * mayby modified.
 *
 * @param loops			The number of reinitializations to find better
 * oc/variance patternsets.
 */
 ...
 * @return 				Copy of the current patternset object
 * (type:
 * patternset)
 */
...
/**
 * A special option, if silent == true but, first and best pattern should be
 * printed.
 *
 * @param sil 			Boolean, if output first and best pattern,
 * although
 * silent == true.
 */
...
/**
 * A special option, if silent == true but the number of improved pattern should
 * be printed.
 *
 * @param sil 			Boolean, if print number of improvements,
 * although
 * silent == true.
 */
...
/**
 * Returns a string containing a speacial output format, if its overlap
 * complexity or not.
 *
 * @return 				String which contains current pattern
 * mode
 * overlap complexity or variance calculation.
 */
