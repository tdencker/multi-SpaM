...
static double evaluateCatFlex(int *ex1, int *ex2, int *cptr, int *wptr,
			      ...
			      unsigned char *tipX1, int n, double *diagptable_start, double *vector, fakeboolean writeVector, const fakeboolean fastScaling, const int numStates)
{
  double   
    sum = 0.0, 
    term,
...
static double evaluateGammaFlex(int *ex1, int *ex2, int *wptr,
				double *x1, double *x2,  
				double *tipVector, 
				unsigned char *tipX1, int n, double *diagptable, double *vector, fakeboolean writeVector, const fakeboolean fastScaling, const int numStates)
{
  double   
    sum = 0.0, 
    term,
...
static double evaluateGammaFlex_LG4(int *ex1, int *ex2, int *wptr,
				    double *x1, double *x2,  
				    double *tipVector[4], 
				    unsigned char *tipX1, int n, double *diagptable, double *vector, fakeboolean writeVector, const fakeboolean fastScaling, const int numStates, double *weights)
{
  double   
    sum = 0.0, 
    term,
...
static double evaluateGammaInvarFlex (int *ex1, int *ex2, int *wptr, int *iptr,
				      ...
				      unsigned char *tipX1, int n, double *diagptable, double *vector, fakeboolean writeVector, const fakeboolean fastScaling,
				      const int numStates)
{
  double   
    sum = 0.0, 
...
static double evaluateGTRCATPROT_SAVE (int *ex1, int *ex2, int *cptr, int *wptr,
    double *x1, double *x2, double *tipVector,
    unsigned char *tipX1, int n, double *diagptable_start, const fakeboolean fastScaling,
...
static double evaluateGTRGAMMA_BINARY(int *ex1, int *ex2, int *wptr,
				      ...
				      double *tipVector, 
				      unsigned char *tipX1, const int n, double *diagptable, const fakeboolean fastScaling)
{
  double   sum = 0.0, term;    
  int     i, j;
#ifndef __SIM_SSE3
...
static double evaluateGTRGAMMAINVAR_BINARY (int *ex1, int *ex2, int *wptr, int *iptr,
					    double *x1_start, double *x2_start,
					    double *tipVector, double *tFreqs, double invariants,
					    unsigned char *tipX1, int n, double *diagptable, const fakeboolean fastScaling)
{ 
  int     i, j, k;
  double  *x1, *x2; 
  double 
...
static double evaluateGTRGAMMAPROT_LG4(int *ex1, int *ex2, int *wptr,
				       double *x1, double *x2,  
				       double *tipVector[4], 
				       unsigned char *tipX1, int n, double *diagptable, const fakeboolean fastScaling, double *weights)
{
  double   sum = 0.0, term;        
  int     i, j, l;   
  double  *left, *right;              
...
double evaluateIterative(tree *tr,  fakeboolean writeVector)
{
  double 
    *pz = tr->td[0].ti[0].qz,
    result = 0.0;   
